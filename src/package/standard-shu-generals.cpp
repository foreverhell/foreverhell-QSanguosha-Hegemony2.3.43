...
class PaoxiaoShow : public ZeroCardViewAsSkill
{
public:
    PaoxiaoShow() : ZeroCardViewAsSkill("paoxiao")
    {
    }
    ...
    virtual QStringList triggerable(TriggerEvent triggerEvent, Room *room, ServerPlayer *player, QVariant &data, ServerPlayer * &) const
    {
        if (TriggerSkill::triggerable(player)) {
            if (triggerEvent == TargetConfirming && player->isKongcheng()) {
                ...
                if (move.to && move.to == player && move.reason.m_skillName == "transfer") {
            ...
            } else if (triggerEvent == EventPhaseStart && player->getPhase() == Player::RoundStart && !player->getPile("zither").isEmpty()) {
                return QStringList(objectName());
            }
        }
        return QStringList();
...
class QicaiShow : public ZeroCardViewAsSkill
{
public:
    QicaiShow() : ZeroCardViewAsSkill("qicai")
    {
    }
...
class QicaiTarget : public TargetModSkill
{
public:
    QicaiTarget() : TargetModSkill("#qicai-target")
    {
        pattern = "TrickCard";
    }
...
class BazhenShow : public ZeroCardViewAsSkill
{
public:
    BazhenShow() : ZeroCardViewAsSkill("bazhen")
    {
    }
...
class BazhenViewHas : public ViewHasSkill
{
public:
    BazhenViewHas() : ViewHasSkill("#bazhen-viewhas")
    {
    }
...
void StandardPackage::addShuGenerals()
{
    ...
    huangyueying->addSkill(new QicaiTarget);
    insertRelatedSkills("qicai", "#qicai-target");
    ...
    wolong->addSkill(new BazhenViewHas);
    insertRelatedSkills("bazhen", "#bazhen-viewhas");
