                        ...
                        if (do_effect) {
                            if (p) {
                                ...
                                if (p->hasSkill("huashen")) {
                                    if (result_skill->getFrequency() == Skill::Frequent || result_skill->getFrequency() == Skill::NotFrequent) {
                                        QStringList huashens = p->property("Huashens").toString().split("+");
                                        foreach (QString name, huashens) {
                                            const General *general = Sanguosha->getGeneral(name);
                                            if (general && general->hasSkill(result_skill->objectName())) {
                                                ...
                                                room->setPlayerProperty(p, "Huashens", huashens.join("+"));
                                                JsonArray arg;
